...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Gran Turismo 2",
    .project_root_env = "GT2_PROJECT_ROOT",
    .build_dir_env = "GT2_BUILD_DIR",
    .force_setup_env = "GT2_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_944.88_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Gran_Turismo_2_Recompiled",
    .prepare_note =
